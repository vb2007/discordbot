...
if (config.id == "your bot id goes here") {
  console.log(
    "Please register a bot here https://discord.com/developers/applications\nand then put the relevant info in settings.json\n\n"
  );
  process.exit(0);
} else
  console.log(
    `https://discord.com/api/oauth2/authorize?client_id=${config.id}&permissions=34816&scope=bot`
  );
