...
const { embedReplyPrimaryColorWithFieldsAndThumbnail } = require("../../helpers/embeds/embed-reply");
	...
	async execute(interaction) {
		...
		const embedReply = embedReplyPrimaryColorWithFieldsAndThumbnail(
			...
			[
				...
				{ name: "Joined", value: `<t:${parseInt(targetMember.joinedAt / 1000)}:R>`, inline: true },
				{ name: "Created", value: `<t:${parseInt(targetUser.createdAt / 1000)}:R>`, inline: true },
				...
				{ name: "Custom presence", value: targetMember.presence?.activities?.map(activity => 
